...
public class InformationApi {
    ...
    public com.squareup.okhttp.Call getInformationCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/v3/information";
     ...
     */
    public InformationDefinition getInformation() throws ApiException {
        ApiResponse<InformationDefinition> resp = getInformationWithHttpInfo();
        return resp.getData();
    }
     ...
     * Lists information
     * Returns relevant information regarding Neoload Web resources and version.
     * @return ApiResponse&lt;InformationDefinition&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InformationDefinition> getInformationWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getInformationValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<InformationDefinition>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call getInformationAsync(final ApiCallback<InformationDefinition> callback) throws ApiException {
