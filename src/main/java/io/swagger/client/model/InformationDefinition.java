...
public class InformationDefinition {
  ...
  **/
  @Schema(example = "https://preprod-neoload-files.saas.neotys.com", description = "URL for Neoload projects file upload and management.")
  ...
  public InformationDefinition version(String version) {
   ...
   /**
   * NeoloadWeb platform version. Will be \&quot;SaaS\&quot; for official NeoLoad SaaS platform.
   * @return version
  **/
  @Schema(example = "SaaS", description = "NeoloadWeb platform version. Will be \"SaaS\" for official NeoLoad SaaS platform.")
